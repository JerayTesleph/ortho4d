...
public abstract class SingleGraphicsCanvas3D implements Canvas3D {
	...
	public final void add(Rectangle2D clip, Rectangle2D relevant,
	...
	@Override
	public final Collection<? extends Canvas2D> getRelevantCanvases(double fromZ,
			double toZ) {
		// To lazy to search for the start
		return canvases.headMap(Double.valueOf(toZ)).values();
	}
